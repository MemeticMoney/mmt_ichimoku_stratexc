...
export function writeOptimizerArtifacts({
  ...
  const summaryLines = [
    ...
    '',
    markdownTable(
      ['Symbol', 'TF', 'HTF', 'Direction', 'Window', 'Cloud', 'PF', 'Win %', 'DD %', 'Trades', 'Pass'],
      bestSettingSummaries.map((summary) => [
        summary.symbol,
        summary.timeframe,
        summary.htfTimeframe,
    ...
    '',
    markdownTable(
      ['Symbol', 'Direction', 'Window', 'Cloud', 'Pass TFs', 'Avg PF', 'Avg Win %', 'Avg DD %', 'TFs', 'HTFs'],
