...
Source artifacts were generated by the optimizer harness under `optimizer/output/` during the research pass. Generated run outputs are intentionally not committed to the public source package.
...
These counts are based on the robust winners generated during the Phase 2 optimizer pass.
...
These counts are based on the passing best cells generated during the Phase 2 optimizer pass.
