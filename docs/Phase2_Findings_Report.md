...
Phase 2 used the symbol-aware optimizer plan from [Phase2_Candidate_Grid.md](./Phase2_Candidate_Grid.md) and [Phase2_Execution_Checklist.md](./Phase2_Execution_Checklist.md).
...
- [summary.md](../optimizer/output/phase2/_latest/summary.md)
- [best-settings.csv](../optimizer/output/phase2/_latest/best-settings.csv)
- [robust-settings.csv](../optimizer/output/phase2/_latest/robust-settings.csv)
- [raw-results.json](../optimizer/output/phase2/_latest/raw-results.json)
...
These counts are based on the robust winners in [robust-settings.csv](../optimizer/output/phase2/_latest/robust-settings.csv).
...
These counts are based on the passing best cells in [best-settings.csv](../optimizer/output/phase2/_latest/best-settings.csv).
